...
public class Tab8Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.tab8_fragment, container, false);
        AdView adView2 = (AdView) view.findViewById(R.id.adView1);
        adView2.loadAd(new AdRequest.Builder().build());
        gift_show = (ImageView) view.findViewById(R.id.giftshow);
        first = (LinearLayout) view.findViewById(R.id.first9);
        second = (LinearLayout) view.findViewById(R.id.second9);
        ...
        if(thisMonth.matches("12")){
            if(thisDay.matches("25")){
                first.setVisibility(View.VISIBLE);
                second.setVisibility(View.GONE);
                gift_show.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(view.getContext(),GiftWallpaperActivity.class);
