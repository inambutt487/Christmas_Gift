...
public class Tab7Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.tab7_fragment, container, false);
        AdView adView2 = (AdView) view.findViewById(R.id.adView1);
        adView2.loadAd(new AdRequest.Builder().build());
        gift_show = (ImageView) view.findViewById(R.id.giftshow);
        first = (LinearLayout) view.findViewById(R.id.first8);
        second = (LinearLayout) view.findViewById(R.id.second8);
